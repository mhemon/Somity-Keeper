...
public class CategoryAdapter3 extends RecyclerView.Adapter<CategoryAdapter3.ViewHolder> {
    ...
    public CategoryAdapter3(List<Article> articles, Context mContext) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.horizontal_scroll_item_3, viewGroup, false);
        return new ViewHolder(v);
    }

    @SuppressLint("SetJavaScriptEnabled")
    @Override
    public void onBindViewHolder(@NonNull final CategoryAdapter3.ViewHolder viewHolder, int position) {
