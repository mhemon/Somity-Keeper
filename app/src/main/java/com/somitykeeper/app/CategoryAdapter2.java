...
public class CategoryAdapter2 extends RecyclerView.Adapter<CategoryAdapter2.ViewHolder> {
    ...
    public CategoryAdapter2(List<Article> articles, Context mContext) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.horizontal_scroll_item2, viewGroup, false);
        return new ViewHolder(v);
    }
    @SuppressLint("SetJavaScriptEnabled")
    @Override
    public void onBindViewHolder(@NonNull CategoryAdapter2.ViewHolder viewHolder, int position) {
