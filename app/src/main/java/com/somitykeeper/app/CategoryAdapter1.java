...
public class CategoryAdapter1 extends RecyclerView.Adapter<CategoryAdapter1.ViewHolder> {
    ...
    public CategoryAdapter1(List<Article> articles1, Context mContext) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final CategoryAdapter1.ViewHolder viewHolder, int position) {

        Article currentArticle = articles1.get(position);
        ...
        viewHolder.itemView.setOnClickListener(view -> {
            String title = articles1.get(viewHolder.getAdapterPosition()).getTitle();
            String Description = articles1.get(viewHolder.getAdapterPosition()).getDescription();
            String Author = articles1.get(viewHolder.getAdapterPosition()).getAuthor();
            String content = articles1.get(viewHolder.getAdapterPosition()).getContent();
    ...
    public int getItemCount() {
        return articles1 == null ? 0 : articles1.size();
    }
