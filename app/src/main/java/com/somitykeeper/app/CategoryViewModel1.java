...
public class CategoryViewModel1 extends ViewModel {
    private MutableLiveData<Channel> articleListLive = null;

    private String urlString = "https://somitykeeper.com/archives/category/recently-added-somity/feed";
    ...
    public void fetchFeed() {
        ...
        parser.onFinish(new OnTaskCompleted() {
            ...
            @Override
            public void onTaskCompleted(@NonNull Channel channel1) {
                setChannel(channel1);
            }
